...
`docs/asf-schema-spec.md` (the constitution, v0.5) before writing any code.
...
SI-1…SI-20 are resolved (SI-20 → A20/M8 in v0.5), new issues start at SI-21.
...
Design rationale lives in the originating claude.ai session (every schema
